...
/// Numeric JSON-RPC code for overload rejection (`ainxt-tool-protocol`
...
const GLOBAL_MAX_INFLIGHT_ENV: &str = "AINXT_TOOL_SERVER_GLOBAL_MAX_INFLIGHT";
...
/// `AINXT_TOOL_SERVER_GLOBAL_MAX_INFLIGHT` when present and parseable as a
