//! Unified MCP adapter for the ainxt Computer Hub.
//!
...
//! tools, and produces [`ToolServerHandler`](ainxt_computer_hub_sdk::ToolServerHandler)
//! implementations that can be registered with a hub
//! [`ToolServerBuilder`](ainxt_computer_hub_sdk::ToolServerBuilder).
//!
//! # Architecture
//!
//! ```text
