...
//! — lock-free per-key concurrent access matches the production
...
use ainxt_tool_runtime::{SearchSnapshot, ServerSummary, Tool, ToolCallContext, ToolError};
        ...
        let matches: Vec<_> = self
            ...
            .filter_map(|r| {
                ...
                if reg.tool_id.as_str().contains(query) {
                    Some(ainxt_tool_runtime::ToolSearchResult {
