...
//!
//! [`TransportKind`] is re-exported from [`ainxt_tool_protocol`] so the wire
...
use ainxt_tool_protocol::{SessionId, ToolId, UserId};
use ainxt_tool_runtime::{ToolCallContext, ToolError, ToolStream, TypedToolOutput};

pub use ainxt_tool_protocol::TransportKind;
