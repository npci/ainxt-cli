...
use ainxt_tool_runtime::{SearchSnapshot, ServerSummary};
...
/// [`ainxt_tool_protocol::ToolSessionBindOutcome`] is a strict subset with
...
/// without awaiting). The split matches how callers use the registry: the
