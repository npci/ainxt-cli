...
/// matching the literal messages produced by the ainxt chat sampler —
...
pub enum CompactionSampleError {
    ...
    ///
    /// Classification is asymmetric for pre-migration equivalence: the *inter*
...
/// Implemented by each harness's sampler adapter; ainxt-build wires its own
/// transport.
///
