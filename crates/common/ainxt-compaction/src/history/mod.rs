...
//! string/text manipulation. Harness-bound extraction (ainxt chat's
//! `AinxtConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `AinxtMessage` assembly) stays in the harness crate.
