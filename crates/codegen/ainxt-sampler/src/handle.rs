...
use ainxt_sampling_types::{ConversationRequest, ConversationResponse, SamplingError};
...
impl SamplerHandle {
    ...
    /// before the actor is wired up. Matches
    /// [`HunkTrackerHandle::noop`](https://docs.rs/ainxt-hunk-tracker).
    pub fn noop() -> Self {
