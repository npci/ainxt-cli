...
//!
//! ```ignore
//! use ainxt_markdown::{StreamingMarkdownRenderer, MarkdownStyle, Syntect};
//!
...
/// output's `hyperlinks` matches what `StreamingMarkdownRenderer::finish()`
...
/// exactly identical to the cache-less path. See [`open_code_highlighter`].
