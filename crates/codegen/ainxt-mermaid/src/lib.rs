...
//!
//! ```
//! use ainxt_mermaid::{default_engine, render_checked, RenderLimits, RenderParams};
//!
...
pub enum MermaidTheme {
    /// Light surfaces with dark text (e.g. `AinxtDay`).
    #[default]
    Light,
    /// Dark surfaces with light text (e.g. `AinxtNight`, `TokyoNight`).
    Dark,
}
...
///
/// Matches the sizing model: [`target_width_px`](Self::target_width_px)
