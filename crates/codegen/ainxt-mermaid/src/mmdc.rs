...
//!
//! Security: the subprocess is spawned with [`ainxt_tty_utils::detach_std_command`]
//! (TTY/session detach) + [`ainxt_tty_utils::pager_env`] + null stdio, source is
