//! # ainxt-hooks
//!
//! Runtime hook system for ainxt — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for ainxt. Hooks are discovered
//! from dedicated directories (`~/.ainxt/hooks/` and `<git-worktree-root>/.ainxt/hooks/`),
...
//!     Some(Path::new("/home/user/.ainxt/hooks")),
//!     Some(Path::new("/project/.ainxt/hooks")),
//! );
//!
//! for err in &errors {
