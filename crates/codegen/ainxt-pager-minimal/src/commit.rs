...
use ainxt_pager::appearance::AppearanceConfig;
use ainxt_pager::minimal_api;
use ainxt_pager::render::Renderable;
use ainxt_pager::scrollback::block::RenderBlock;
use ainxt_pager::scrollback::blocks::ToolCallBlock;
use ainxt_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use ainxt_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                ainxt_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
