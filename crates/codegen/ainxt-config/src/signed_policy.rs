...
/// Confirm the on-disk artifacts match the signed payload exactly — an in-place
...
/// Outcome of reading the on-disk sidecar; matches the artifact-slot semantics of
...
pub enum SignedVerdict {
    ...
    /// /etc/ainxt and MDM layers. Otherwise the marker decides.
    NoAuthenticSidecar,
