//! Config file loading for ainxt.
//!
//! Merge order (lowest → highest priority):
//! 1. `/etc/ainxt/managed_config.toml`
//! 2. `$AINXT_HOME/managed_config.toml`
//! 3. `$AINXT_HOME/config.toml`
//! 4. `$AINXT_HOME/requirements.toml` (cloud cache; Ed25519-signed at rest once a
//!    key is embedded — see [`signed_policy`] — below the OS-protected layers)
//! 5. `/etc/ainxt/requirements.toml`
//! 6. macOS MDM managed preferences (`dev.ainxt`, admin-forced) — macOS only
//!
...
pub use paths::{
    ...
    default_ainxt_home, encode_cwd_dirname, ensure_sessions_cwd_dir, ainxt_application,
    ainxt_application_in, ainxt_home, sessions_cwd_dir, system_config_dir, user_ainxt_home,
};
pub use validation::{
