...
//! `AINXT_SCROLL_LOG` pointed at a tempfile, then validates the pager's
//! flight-recorder JSONL (producer:
//! `ainxt-pager/src/input/scroll_log.rs`) against gesture invariants.
//!
...
//! producer-side twin lives in `ainxt-pager/src/input/mouse/tests.rs`
