//! MCP server configuration value types, extracted from ainxt-shell
...
use ainxt_mcp::oauth_config::McpOAuthConfig;
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("AINXT_RELAY_SYNC_ENABLED") {
