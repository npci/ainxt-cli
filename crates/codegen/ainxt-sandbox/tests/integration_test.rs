//! Integration tests for ainxt-sandbox.
//!
...
fn test_sandbox_logger() {
    use ainxt_sandbox::{SandboxEvent, SandboxLogger};
...
fn test_should_restrict_child_network_default() {
    ...
    assert!(!ainxt_sandbox::should_restrict_child_network());
}
