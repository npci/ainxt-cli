...
//!
//! In dev mode, watches ~/.ainxt/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.ainxt/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.ainxt/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = ainxt_config::user_ainxt_home()
