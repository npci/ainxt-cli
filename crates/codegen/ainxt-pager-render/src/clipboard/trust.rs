...
///
/// - `osc52_sink`: when `ainxt wrap` is capturing this process's output (see
...
mod tests {
    ...
    // `ainxt wrap` sink: a brand that does NOT natively support OSC 52 (the
    ...
    // container override is deliberately narrow; `ainxt wrap` is the SSH path.
    #[test]
