...
/// WSL detection. The implementation lives in `ainxt-tty-utils` (the shared
...
pub use ainxt_tty_utils::is_wsl;
...
// tests live with the implementation in `ainxt-tty-utils`.
