...
//! Dark themes (AinxtNight, TokyoNight) share `ainxt-night.tmTheme`;
//! AinxtDay uses `ainxt-day.tmTheme` with deepened colors for light backgrounds.

use std::sync::OnceLock;

pub use ainxt_markdown::Syntect;

use crate::theme::ThemeKind;

static SYNTECT_AINXTNIGHT: OnceLock<Syntect> = OnceLock::new();
static SYNTECT_TOKYONIGHT: OnceLock<Syntect> = OnceLock::new();
static SYNTECT_AINXTDAY: OnceLock<Syntect> = OnceLock::new();
...
pub fn get_syntect() -> &'static Syntect {
    match crate::theme::Theme::current_kind() {
        ...
        | ThemeKind::Auto => SYNTECT_AINXTNIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/ainxt-night.tmTheme"))),
        ThemeKind::TokyoNight => SYNTECT_TOKYONIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/tokyo-night.tmTheme"))),
        ThemeKind::AinxtDay => SYNTECT_AINXTDAY
            .get_or_init(|| Syntect::new(include_bytes!("../assets/ainxt-day.tmTheme"))),
    }
}
