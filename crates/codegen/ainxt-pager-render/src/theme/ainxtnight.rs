//! AinxtNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// AinxtNight palette — neutral gray base + TokyoNight accent colors.
//
