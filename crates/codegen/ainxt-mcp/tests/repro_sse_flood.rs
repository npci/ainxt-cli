...
//!
//! Run with: cargo test -p ainxt-mcp --test repro_sse_flood -- --nocapture
...
use ainxt_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use ainxt_mcp::rmcp::ServiceExt;
use ainxt_mcp::rmcp::transport::StreamableHttpClientTransport;
use ainxt_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
