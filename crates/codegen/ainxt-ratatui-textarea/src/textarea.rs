...
impl TextArea {
    ...
    pub fn input(&mut self, event: KeyEvent) {
        ...
        match event {
            ...
            // Cmd+D (macOS Kitty), Ctrl+Delete (Linux/Windows; matches Ctrl+Backspace).
            KeyEvent {
                code: KeyCode::Delete,
                modifiers: KeyModifiers::ALT,
                ..
            ...
            // Readline equivalence: C-w is unix-word-rubout; M-DEL/C-Backspace
    ...
    /// buffer text back unchanged. Each `(range, kind, display)` tuple
...
mod tests {
    ...
    /// Readline equivalence: only C-w is whitespace-delimited; M-DEL/C-Backspace
    /// stay chunked.
    #[test]
