...
//!
//! Run with: cargo run -p ainxt-ratatui-textarea --example textarea_demo
//!
...
use ainxt_ratatui_textarea::wrapping::{RtOptions, word_wrap_line};
use ainxt_ratatui_textarea::{
