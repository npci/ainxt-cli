...
//! Cache root: `~/.ainxt/marketplace-cache/<url-hash>/`
...
pub fn default_cache_root() -> PathBuf {
    ainxt_config::ainxt_home().join("marketplace-cache")
}
...
mod tests {
    ...
    fn cache_hash_is_deterministic() {
        let url = "https://github.com/ainxt-org/ainxt-plugin-marketplace.git";
    ...
    #[test]
    fn default_cache_root_under_ainxt() {
