//! Public event types — the wire contract for `ainxt-fsnotify`.
//!
...
//! translator (in `ainxt-workspace`) maps these to
...
/// Aligned with `ainxt_workspace_types::FsEventKind` (identity map at
