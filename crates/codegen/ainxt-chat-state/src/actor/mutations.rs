...
impl ChatStateActor {
    ...
    /// Out-of-band history repair (`ainxt.dev/session/repair`): run
    ...
    /// on disk matches the in-memory state — both lose old bulk content but
        ...
        self.state
            ...
            .map(|item| match item {
                ...
                ConversationItem::Reasoning(r) => {
                    ainxt_sampling_types::reasoning_item_text(r).len()
    ...
    pub(super) fn record_last_turn_usage(&mut self, usage: ainxt_sampling_types::TokenUsage) {
    ...
    pub(super) fn record_model_call_usage(
        ...
        usage: &ainxt_sampling_types::TokenUsage,
