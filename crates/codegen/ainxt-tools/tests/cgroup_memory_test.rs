...
//! cargo test -p ainxt-tools --test cgroup_memory_test -- --ignored --nocapture
//!
//! # If you need root:
//! sudo -E cargo test -p ainxt-tools --test cgroup_memory_test -- --ignored --nocapture
//! ```
//!
...
use ainxt_tools::computer::local::cgroup::{CgroupMemoryConfig, PROCESS_OOM_EXIT_CODE};
use ainxt_tools::computer::types::{TerminalBackend, TerminalRunRequest, TerminalRunResult};
