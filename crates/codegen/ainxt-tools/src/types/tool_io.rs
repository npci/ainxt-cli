...
use crate::implementations::ainxt_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::ainxt_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::ainxt_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::ainxt_build::grep::GrepSearchInput;
use crate::implementations::ainxt_build::image_edit::ImageEditInput;
use crate::implementations::ainxt_build::image_gen::ImageGenInput;
use crate::implementations::ainxt_build::list_dir::ListDirInput;
use crate::implementations::ainxt_build::read_file::ReadFileInput;
use crate::implementations::ainxt_build::search_replace::SearchReplaceInput;
...
use ainxt_tool_types::KillTaskToolInput;
use ainxt_tool_types::TaskOutputToolInput;
use ainxt_tool_types::TaskToolInput;
use ainxt_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::ainxt_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::ainxt_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::ainxt_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::ainxt_build::scheduler::list::SchedulerListInput),
