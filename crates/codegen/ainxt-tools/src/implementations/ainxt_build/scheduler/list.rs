...
impl ainxt_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl ainxt_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> ainxt_tool_protocol::ToolId {
        ainxt_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, ainxt_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                ainxt_tool_runtime::ToolError::execution(
                    ainxt_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
