...
impl crate::types::tool_metadata::ToolMetadata for ReadFileConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::AinxtBuildConcise
    }
...
impl ainxt_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // AinxtBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::ainxt_build::read_file::ReadFileTool;
