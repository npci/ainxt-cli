...
use crate::implementations::ainxt_build::bash::{
...
impl ainxt_tool_runtime::Tool for BashConciseTool {
    ...
    async fn run(
        ...
        let result = ainxt_tool_runtime::Tool::run(&BashTool, ctx, input).await?;
...
mod tests {
    ...
    fn no_double_header_after_default_prebake() {
        ...
        bash.output_for_prompt =
            crate::implementations::ainxt_build::bash::format_default_prompt(&bash);
