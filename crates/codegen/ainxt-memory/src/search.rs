...
use ainxt_config_types::MemorySearchConfig;
...
mod tests {
    ...
    use ainxt_config_types::{MemoryIndexConfig, MemorySearchConfig};
    ...
    /// The auto-generated global MEMORY.md stub, written unchanged by
