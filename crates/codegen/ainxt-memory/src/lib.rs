...
//! ainxt to persist important information across sessions. Memory files are
//! stored under `~/.ainxt/memory/` with workspace-scoped subdirectories
...
//! `AINXT_MEMORY=1` environment variable. When disabled, this crate
