//! ainxt Speech-to-Text language codes.
//!
//! Source of truth for the `language` query/form parameter on
//! `https://api.example.test/v1/stt` and `wss://api.example.test/v1/stt`.
//!
//! Official catalog (25 languages):
//! <https://docs.example.test/developers/model-capabilities/audio/speech-to-text#supported-languages>
//!
...
/// Official ainxt STT languages (docs.ainxt.dev), sorted by English name.
///
...
mod tests {
    ...
    fn catalog_matches_public_docs_exactly() {
        ...
        assert_eq!(
            ours, docs,
            "STT_LANGUAGES drifted from docs.ainxt.dev supported languages"
        );
    }
