//! Criterion benchmarks for the ainxt-pager rendering pipeline.
//!
...
use ainxt_pager::scrollback::render::render_scrolled_entries_with_scratch;
use ainxt_pager::scrollback::wrappers::EntryRenderer;
use ainxt_pager::scrollback::{
