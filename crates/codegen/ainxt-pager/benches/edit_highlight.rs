...
//!
//! ```text
//! cargo bench -p ainxt-pager --bench edit_highlight
//! cargo bench -p ainxt-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use ainxt_pager::diff::{DiffHunk, DiffLine};
use ainxt_pager::scrollback::blocks::tool::{
...
use ainxt_pager::syntax::{Syntect, get_syntect};
