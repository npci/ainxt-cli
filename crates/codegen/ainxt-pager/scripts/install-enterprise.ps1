...
if ($PSVersionTable.Platform -and $PSVersionTable.Platform -ne 'Win32NT') {
    Write-Error "This installer is for Windows. On macOS/Linux, run install-enterprise.sh from this repository (crates/codegen/ainxt-pager/scripts/), with AINXT_BASE_URL set to your artifact host."
    exit 1
}
