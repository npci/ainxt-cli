...
mod tests {
    ...
    fn goal_line_paused_chip_uses_warning_background() {
        ...
        //
        // Use the unquantized `ainxtnight()` theme directly so warning and
    ...
    // The old deliverable-index equivalence test is removed because deliverables
