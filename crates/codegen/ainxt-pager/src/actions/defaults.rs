...
pub fn default_actions(mouse_reporting_toggle_enabled: bool) -> Vec<ActionDef> {
    ...
    actions.extend([
        ...
        // rebind any of them through `~/.ainxt/config.toml`.
        ActionDef {
        ...
        ActionDef {
            ...
            //     mouse handler.
            // The `default_key` matches the real primary route, Ctrl+\
        ...
        // Dashboard-equivalence stop inside the session overlay — state
