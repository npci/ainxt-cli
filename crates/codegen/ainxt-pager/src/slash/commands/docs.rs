...
//! `/docs web` opens https://docs.example.test/build/overview in the browser.
...
/// Online Build docs landing page.
/// Override at runtime with `AINXT_URL_DOCS`.
pub const BUILD_DOCS_URL: &str = ainxt_env::URL_DOCS;
...
impl SlashCommand for DocsCommand {
    ...
    fn description(&self) -> &str {
        "Open the how-to guides or the ainxt documentation"
    }
    ...
    fn suggest_args(&self, _ctx: &AppCtx, _args_query: &str) -> Option<Vec<ArgItem>> {
        let mut items = vec![
            ...
            ArgItem {
                ...
                description: "Open docs.ainxt.dev/build in the browser".into(),
            },
        ];
