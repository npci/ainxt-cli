...
/// slice; the constant pulls the canonical name from `ainxt-tools`
...
impl SlashCommand for LoopCommand {
    ...
    fn description(&self) -> &str {
        "Schedule a prompt to run again on a set interval"
    }
...
mod tests {
    ...
    // `loop_prompt_matches_pager_wording`, this pins full shell↔pager equivalence.
    #[test]
