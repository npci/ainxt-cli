...
/// Open the interactive third-party settings import modal in the active session.
...
impl SlashCommand for ImportClaudeCommand {
    ...
    fn description(&self) -> &str {
        "Bring in settings from a supported third-party tool"
    }
    ...
    /// Hidden from the command dropdown and help: the third-party import flow
    /// is still executable if typed, but is not advertised in the ainxt UI.
