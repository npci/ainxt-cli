...
// -> allow-once -> reject) so the picker matches what the user sees on the
// real prompt.
...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain ainxt in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain ainxt in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `ainxt_voice::STT_LANGUAGES` (official ainxt STT
// catalog — https://docs.example.test/developers/model-capabilities/audio/speech-to-text).
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain ainxt opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "ainxtnight".
                default: "ainxtnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "ainxtnight".
                default: "ainxtnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "ainxtday".
                default: "ainxtday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "ainxt", "switch"],
        ...
        // The `AINXT_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        SettingMeta {
            ...
            description: "Controls whether ainxt may retain and train on coding session data.",
            keywords: &[
                "privacy",
                "data",
                "sharing",
        ...
        // follows the process locale when it maps to a ainxt STT language.
        // Catalog = official STT languages (see ainxt_voice::STT_LANGUAGES).
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (ainxt STT). \
