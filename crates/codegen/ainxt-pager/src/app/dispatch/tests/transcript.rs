...
fn plugins_list_response() -> ainxt_hooks_plugins_types::PluginsListResponse {
    use crate::views::extensions_modal::test_plugin_info;
    ainxt_hooks_plugins_types::PluginsListResponse {
        plugins: vec![
            test_plugin_info(
                "user-tool",
                Some(ainxt_hooks_plugins_types::PluginOrigin::UserAinxt),
            ),
            test_plugin_info(
                "claude-tool",
                Some(ainxt_hooks_plugins_types::PluginOrigin::UserClaude),
            ),
        ],
    }
}
