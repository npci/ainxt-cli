#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// notifications through the generic `ainxt.dev/session/update` envelope. A
    ...
    fn ext_session_update_replay_restores_bg_task() {
        ...
        let update = AinxtSessionUpdate::TaskBackgrounded {
        ...
        handle(
            make_ext_session_notification_with_method("sess-1", "ainxt.dev/session/update", update),
            &mut app,
        );
    ...
    fn task_backgrounded_with_wire_description_still_drains_deferred_tool() {
        ...
        let notif = acp::ExtNotification::new("ainxt.dev/task_backgrounded", raw.into());
