#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn inject_prompt_drives_even_when_attached_as_viewer() {
        // The leader routes `ainxt.dev/scheduled_task_inject_prompt` to the SINGLE
    ...
    fn inject_prompt_malformed_json_returns_false() {
        ...
        let notif = acp::ExtNotification::new("ainxt.dev/scheduled_task_inject_prompt", raw.into());
    ...
    fn fired_unknown_task_with_none_next_fire_skips_insert() {
        // Matches handle_missed_tasks output: a missed one-shot fires with
