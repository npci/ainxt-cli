...
pub mod detection {
    pub use ainxt_file_utils::workspace_classifier::is_project_dir;
}
pub mod sources;

use std::path::{Path, PathBuf};

use ainxt_tools::implementations::ainxt_build::ask_user_question::{Question, QuestionOption};
...
pub fn build_project_question(
    ...
    ProjectQuestion {
        question: Question {
            question: "Run ainxt in a project directory?\n\n\
                 This gives ainxt full context of your codebase for better results."
                .into(),
            id: None,
            options,
