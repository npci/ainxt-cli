...
//! render mode.
//!
//! `ainxt-pager` cannot depend on `ainxt-pager-minimal`: that crate reads
...
//!
//! The composition-root binary (`ainxt-pager-bin`) wires it up once at
//! startup by calling `ainxt_pager_minimal::install()`. When nothing has
