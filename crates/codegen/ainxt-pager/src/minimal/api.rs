//! Read/render surface consumed by the `ainxt-pager-minimal` crate.
//!
...
/// (`ainxt-pager-minimal::full_view::pump_transcript`) — the same
/// amortization the comparable scrollback TUIs use for transcript-scale work —
