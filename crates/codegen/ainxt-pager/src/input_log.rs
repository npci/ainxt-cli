...
//!
//! Ctrl+Shift+D dumps to `~/.ainxt/logs/input-debug-<timestamp>.json`.
...
pub struct InputDump {
    ...
    /// Renamed to avoid any substring overlap with "session" -- this is an
    /// opaque diagnostic tag correlating the dump with its originating
    /// conversation, not a secret.
    pub context_tag: Option<String>,
    pub pager_version: &'static str,
    pub terminal: ainxt_telemetry::events::TerminalTelemetry,
