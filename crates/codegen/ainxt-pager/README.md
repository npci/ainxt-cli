...
Terminal UI (TUI) for AiNxt CLI. Provides the interactive full-screen interface
...
- [Hook Examples](../ainxt-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`ainxt-hooks`)](../ainxt-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`ainxt-plugin-marketplace`)](../ainxt-plugin-marketplace/) — marketplace source loading, scanning, and install
