...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "ainxt-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "ainxt-3", "researcher");
    ...
    let shared_models = ["ainxt-3", "ainxt-3-mini"];
