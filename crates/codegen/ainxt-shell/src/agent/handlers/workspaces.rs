...
mod tests {
    ...
    #[test]
    fn success_response_projects_ainxt_workspace_fields() {
    ...
    fn degraded_response_carries_partial_reason() {
        ...
        assert_eq!(value["_meta"]["ainxt.dev/partial"]["workspaces"], true);
        assert_eq!(value["_meta"]["ainxt.dev/partial"]["reason"], "no_oauth");
    }
}
