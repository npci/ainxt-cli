...
use ainxt_workspace::file_system::ContentSearchRequest as ContentSearchRequestParams;
use ainxt_workspace::workspace_ops::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        ...
        "ainxt.dev/search/content" => {
            ...
            // `ainxt.dev/search/content/status` batches through the client sink.
