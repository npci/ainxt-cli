...
pub(crate) const ENV_REMEMBER_TOOL_APPROVALS: &str = "AINXT_REMEMBER_TOOL_APPROVALS";
...
/// shown. Precedence: requirements > env (`AINXT_REMEMBER_TOOL_APPROVALS`) >
...
mod remember_tool_approvals_gate_tests {
    ...
    // `AINXT_REMEMBER_TOOL_APPROVALS` is process-global; serialize and force it
