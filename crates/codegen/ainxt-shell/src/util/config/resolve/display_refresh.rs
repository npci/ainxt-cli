...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "AINXT_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "AINXT_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`AINXT_MIN_DRAW_MS` / `AINXT_SCROLL_CADENCE_MS`).
