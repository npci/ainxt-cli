...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "AINXT_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`AINXT_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "AINXT_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`AINXT_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "AINXT_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`AINXT_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `AINXT_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("AINXT_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes AINXT_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
