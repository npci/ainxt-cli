...
pub(crate) trait ExternalCommandRunner: Send + Sync {
    ...
    fn run_external_command(&self, command: &str) -> Option<AinxtAuth>;
}
...
impl RefreshOutcome {
    ...
    pub(crate) fn success(auth: AinxtAuth) -> Self {
...
mod tests {
    use super::*;
    use crate::auth::{AuthMode, AinxtAuth, AinxtComConfig};
