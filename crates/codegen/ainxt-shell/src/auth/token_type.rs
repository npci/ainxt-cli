...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&AinxtAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> ainxt_telemetry::events::AuthTokenKind {
        use ainxt_telemetry::events::AuthTokenKind as K;
        match self {
