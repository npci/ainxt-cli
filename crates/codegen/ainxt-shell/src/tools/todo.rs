//! Todo types — re-exported from `ainxt-tools` with ACP conversion helpers.
//!
//! Types are canonical in `ainxt-tools`. This module adds ACP ↔ TodoItem
//! conversions since `ainxt-tools` is protocol-agnostic.

pub use ainxt_tools::implementations::ainxt_build::todo::TodoId;
pub use ainxt_tools::implementations::ainxt_build::todo::TodoItem;
pub use ainxt_tools::implementations::ainxt_build::todo::TodoPriority;
pub use ainxt_tools::implementations::ainxt_build::todo::TodoState;
pub use ainxt_tools::implementations::ainxt_build::todo::TodoStatus;
