...
//! ainxt-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use ainxt_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use ainxt_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn ainxt_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<ainxt_tools::implementations::ainxt_build::task::types::MonitorEventBuffer>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = ainxt_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
