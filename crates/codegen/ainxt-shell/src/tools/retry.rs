//! Retry utilities — re-exported from `ainxt-tools`.
//!
//! The canonical implementation now lives in `ainxt_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use ainxt_tools::retry::BackoffConfig as RetryConfig;
pub use ainxt_tools::retry::{BackoffConfig, execute_with_backoff};
