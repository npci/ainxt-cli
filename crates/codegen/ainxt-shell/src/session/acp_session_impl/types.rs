...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<ainxt_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
/// new variant forces a new const + arm. Matches the
...
pub(crate) enum DrainSource {
    Pending(ainxt_tools::implementations::ainxt_build::update_goal::UpdateGoalInput),
    Channel(ainxt_tools::implementations::ainxt_build::update_goal::UpdateGoalEnvelope),
}
