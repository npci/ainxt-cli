...
use ainxt_sampling_types::{ContentPart, ConversationItem, SyntheticReason, UserItem};
...
/// cached radix stream before the planner's first inference. Matches
...
/// insert must be skipped. Matches that branch; production equivalence via
/// grep + review.
#[test]
