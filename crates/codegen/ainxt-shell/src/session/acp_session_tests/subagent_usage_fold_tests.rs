...
fn usage_rows() -> Vec<(String, ainxt_chat_state::UsageTotals)> {
    vec![(
        "m".into(),
        ainxt_chat_state::UsageTotals {
            input_tokens: 40,
            model_calls: 1,
            ..Default::default()
        },
...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use ainxt_tools::implementations::ainxt_build::task::types::SubagentOutstandingReply;
...
> {
    use ainxt_tools::implementations::ainxt_build::task::types::SubagentEvent;
