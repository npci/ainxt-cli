...
use ainxt_chat_state::{MEMORY_CONTEXT_CLOSE_TAG, MEMORY_CONTEXT_OPEN_TAG};
use ainxt_sampling_types::ConversationItem;
use ainxt_tools::types::memory_backend::{MemorySearchResult, format_staleness_note};
...
/// leading system message. Callers reuse a persisted block unchanged instead
...
mod tests {
    ...
    fn test_format_memory_reminder_empty_results_is_none() {
        use ainxt_tools::types::memory_backend::MemorySearchResult;
