...
use ainxt_tools::implementations::ainxt_build::task::types::{SubagentRequest, SubagentResult};
pub(crate) type GatewayOut = <acp::AgentSide as ainxt_acp_lib::AcpSide>::OutMessage;
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(ainxt_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-ainxt-test"),
        ...
        parent_skills: None,
        parent_skills_config: ainxt_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: ainxt_tools::types::compat::CompatConfig::default(),
        auto_wake_delivered: None,
        synthetic_trace_tx: None,
        task_output_tool_name: ainxt_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl ainxt_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &ainxt_tools::implementations::lsp::LspToolInput,
    ) -> ainxt_tools::implementations::lsp::LspToolResult {
        ainxt_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<ainxt_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<ainxt_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
