...
//
// State is persisted to `~/.ainxt/claude_import_state.json`.
...
use ainxt_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.ainxt/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::ainxt_home::ainxt_home().join("claude_import_state.json")
}
