...
- The "Managed by ainxt.dev" link in the Extensions modal is now clickable and underlined.
...
- **ainxt --minimal** now aligns the prompt, status bar, and messages flush-left with the welcome card.
