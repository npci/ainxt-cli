...
- **File links and media** now work for worktree sessions under ~/.ainxt/worktrees/.
...
- **Terminal command cards** on ainxt.dev now correctly settle after foreground bash tasks.
