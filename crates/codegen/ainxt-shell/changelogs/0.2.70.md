...
- **Added `ainxt wrap`** to run any command with local clipboard support.
...
- **Fixed `ainxt agent stdio` startup hangs** on Windows when used with persistent clients such as VS Code or ainxt-desktop.
