...
name: image
description: >
  How to use the image_gen and image_edit tool calls in ainxt: when to
  ...
  images.
metadata:
  short-description: "Prompting and workflow guidance for ainxt image tools"
---

# Image Generation

Guidance for the two image tool calls in ainxt:
...
> The video tools below may not exist - verify they're available before calling them; if they're not, the user cannot do video gen.
