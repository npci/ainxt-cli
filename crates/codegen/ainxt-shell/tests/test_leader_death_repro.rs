...
//!
//! Scenario (matches the field report "clients see `unknown session id` after
//! the leader dies"):
//!
//! 1. Two stdio clients (`ainxt agent --leader stdio`) share one leader.
...
//!
//! ```bash
//! cargo test -p ainxt-shell --test test_leader_death_repro -- --ignored --nocapture
//! ```
