...
//! for the shell's `ainxt.dev/fs/*` ACP extension methods.
//!
//! These mirror the pure functions that previously lived only in the
//! shell (`ainxt-shell/src/session/file_system.rs`) so that, in proxy
//! mode, a `ainxt.dev/fs/*` request executes on the *remote* workspace server
...
use ainxt_workspace_types::rpc::fs::FsReadEncoding;
...
// =========================================================================
// Pure helpers — ported unchanged from the shell so output is identical.
// =========================================================================
