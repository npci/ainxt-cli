...
// its wire types live in `ainxt_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use ainxt_workspace_types::rpc::fs::FsReadEncoding;
...
pub use ainxt_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
