...
/// Decrypt XOR-obfuscated template data (matches `scripts/encrypt_templates.py::xor_encrypt`).
...
/// The base prompt template source, exposed for `ainxt prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `ainxt prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard ainxt-build tool kinds.
