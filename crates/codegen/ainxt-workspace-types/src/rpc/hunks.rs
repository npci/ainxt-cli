...
/// Wire-safe hunk action enum. Maps to `ainxt_hunk_tracker::types::HunkAction`
...
// =========================================================================
// Request types whose responses reference `ainxt_hunk_tracker` types (which pull
...
// =========================================================================
// Wire matches of `ainxt_hunk_tracker` response types
// =========================================================================

/// Wire mirror of `ainxt_hunk_tracker::types::Hunk` (the `selected` field is
...
/// Wire mirror of `ainxt_hunk_tracker::types::HunkLineInfo`.
...
/// Wire mirror of `ainxt_hunk_tracker::types::HunkSource`.
///
...
/// Wire mirror of `ainxt_hunk_tracker::types::FileContentStatus`.
///
...
/// Wire mirror of `ainxt_hunk_tracker::types::FileContentView`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `ainxt_hunk_tracker::types::FileContentEntry`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `ainxt_hunk_tracker::types::SessionStats`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `ainxt_hunk_tracker::types::TurnSummary`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `ainxt_hunk_tracker::types::SessionSummary`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Response containing a filtered set of hunks. Matches the server-side
