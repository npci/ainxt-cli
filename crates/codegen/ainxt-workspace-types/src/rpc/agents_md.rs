...
/// Claude.md / `.ainxt/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.ainxt` and compat dirs.
...
/// Matches the serde shape of `ainxt-agent`'s `AgentConfigFile`.
