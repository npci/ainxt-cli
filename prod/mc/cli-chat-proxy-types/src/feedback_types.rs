...
//!
//! These types support the feedback collection system for ainxt sessions.
//! The agent (ainxt-shell) uses heuristics to determine when to request feedback,
...
fn default_tier1_prompt() -> String {
    "You've been using ainxt productively! Would you mind sharing quick feedback?".to_string()
}
